...
**     Date/Time   : 2016-02-07, 14:00, # CodeGen: 1
**     Contents    :
...
byte TSS1_Configure(void)
{
  ...
  u8Result |= TSS_SetASliderConfig(AnalogSlider.ControlId, ASlider_MovementTimeout_Register, 0x00);
  /* Configure the Analog Slider Range Register */
  u8Result |= TSS_SetASliderConfig(AnalogSlider.ControlId, ASlider_Range_Register, 0x64);
